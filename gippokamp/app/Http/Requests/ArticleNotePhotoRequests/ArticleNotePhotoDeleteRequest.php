...
namespace App\Http\Requests\ArticleNotePhotoRequests;
...
class ArticleNotePhotoDeleteRequest extends FormRequest
{
    use ApiResponse;
    ...
    {
        return [
            'ids' => ['required', 'array', 'exists:article_note_photos,id'],
        ];
    }
